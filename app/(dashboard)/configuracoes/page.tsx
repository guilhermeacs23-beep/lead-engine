        ...
        {tab === 'aparencia' && (
          ...
          <a href="/mapa-do-site"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[14px] font-semibold" style={{ color: 'var(--text-primary)' }}>Mapa do Site</p>
                <p className="text-[12px]" style={{ color: 'var(--text-tertiary)' }}>Visão geral de todos os módulos e navegação completa</p>
              </div>
            </div>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.35)" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>
          </a>
</div>
    </div>
  )
