...
// --- código original mantido abaixo como referência ---
// 'use client'
                  ...
                  return (
                    <div key={a.tipo} className="flex flex-col gap-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[12px] font-semibold text-white">{a.count}</span>
                      </div>
                      <div className="h-1 w-full overflow-hidden rounded-full bg-white/10">
                        <div className="h-full rounded-full bg-indigo-400/70"
                          style={{ width: pct + '%' }} />
                      </div>
                    </div>
                  )
